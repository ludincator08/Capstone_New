...
use PHPMailer\PHPMailer\Exception;
  ...
  function send_mail($email, $token, $type)
  {
    ...
    try{
      ...
      $mail->Username   = "homes.capstone.project@gmail.com";     //SMTP username
      $mail->Password   = "nyeh ousz djhl sobc";                  //SMTP password
      ...
      $mail->Body    = "Click the link to $content: 
  ...
  if(isset($_POST['register']))
  {
    ...
    // match password and confirm pass
