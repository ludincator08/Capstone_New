        ...
        <?php 
          ...
          while($room_data = mysqli_fetch_assoc($room_res))
          {
            ...
            if(!$general_r['shutdown']){
              ...
              $reserve_btn = "<button onclick='checkLoginToReserve($login, $room_data[id])' class='btn w-100 btn-sm text-white custom-bg shadow-none mb-2'>Reserve Now</button>";
            }
              ...
              <div class="card mb-4 border-0 shadow">
                <div class="row g-0 p-3 align-items-center">
                  ...
                  <div class="col-md-5 mb-lg-0 mb-md-0 mb-3">
                    <img src="$room_thumbnail" alt="Thumbnail" class="img-fluid rounded" >
                  </div>
