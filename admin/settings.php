            ...
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="site_about" class="form-control shadow-none" id="site_about_inp" rows="6" required></textarea>
                                    </div>
                                </div>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            No customers will be allowed to book room, when shutdown mode is turn on.
                        </p>
                    </div>
                </div>
